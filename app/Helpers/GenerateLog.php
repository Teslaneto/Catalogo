...
{
    /**
     * Método estático para gerar logs no arquivo de log.
     *
     ...
     * @return void
     */
    public static function generateLog(string $level, string $message, ?array $content = null): void
    {
        // Criar o logger
        $log = new Logger('name');
     ...
     self::logToDatabase($level, $message, $content);
    }
     ...
     * @return void
     */
    private static function logToDatabase(string $level, string $message, ?array $content = null): void
    {
        ...
        $sql = 'INSERT INTO logs (endpoint, dados_requisicao, status_resposta, mensagem_erro) 
